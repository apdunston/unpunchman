...
module.exports = class Bushes extends Scene {
  constructor(grid, animationDisplay) {
    ...
    this.addObject(new Door({grid: grid, x: 0, y: 6, width: 1, height: 2.2, showBoundingBox: true}))
    this.addObject(new Door({grid: grid, x: 9, y: 6, width: 1, height: 2.2, showBoundingBox: true}))
