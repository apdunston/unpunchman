...
module.exports = function() {
   ...
   * 16x9 ratio
   */
  HollowCart.prototype.adjustCanvas = function(yRatio, xRatio) {
    ...
    var canvasHeight = Math.floor(canvasLength / xRatio * yRatio);
    canvas.attr('height', canvasHeight).attr('width', canvasLength);
    
    while (canvasLength > 0 && !canvas.visible()) {
      canvasLength -= 5;
      canvasHeight = Math.floor(canvasLength / xRatio * yRatio);
      canvas.attr('height', canvasHeight).attr('width', canvasLength);
    }
